  ...
  return (
    <div className='m-5'>
      ...
      <p class='text-gray-400 text-sm pt-6'>
        ...
        endorsement, or sponsorship of any security, company, or fund, Funding
        pips does not act as or conduct services as a broker. Funding pips does
        not act as or conduct services as a custodian. People who register for
        our programs do so at their own volition, Purchases of programs should
        not be considered deposits. All program fees are used for operation
        costs including, but not limited to, staff, technology and other
        business related expenses. Nothing contained herein is a solicitation or
        an offer to buy or sell futures, options, or forex. Past performance is
        not necessarily indicative of future results. Applicable law to be under
        the laws of The United Arab Emirates.
      </p>
      <p class='text-gray-400 font-semibold text-sm pt-6'>
      ...
      <div class='flex justify-center space-x-2'>
        <a
          ...
          rel='noreferrer'
          target='_blank'
          className='p-3 rounded-full bg-gray-100 dark:bg-dark-light'
        >
          <svg
